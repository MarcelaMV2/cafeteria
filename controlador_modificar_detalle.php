...
if(!empty($_POST['modificar'])){
   ...
   /* $subcategoria=$_POST['subcategoria'];
    ...
    if(!empty($_POST["precio"]) and !empty($_POST["cantidad"])){
        $registro = $cnx->query("UPDATE DETALLE_TEM (ID_SUB,PRODUCTO,PRECIO,CANTIDAD,TOTAL,MENSAJE) VALUES('$subcategoria','$idSub','$precio','$cantidad','$costo','$mensaje')");
