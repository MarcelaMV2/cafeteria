        ...
        <div class="body_tabla">
            <table >
                ...
                <?php
                    ...
                    $sql = "SELECT ID_CLIENTE,NOMBRE_CLI,CI_CLIENTE,DIRECCION,FECHA_CLI FROM CLIENTE ORDER BY ID_CLIENTE ASC";
                    ...
                    <tr>
                        ...
                        <td> 
                            ...
                            ?"> EDITAR</a>
                            <a href="sp_eliminarCli.php ? id_cli=<?php echo $mostrar['0'] ?>"> ELIMINAR</a>
                        </td>
                    </tr>
                    <?php
                    }
